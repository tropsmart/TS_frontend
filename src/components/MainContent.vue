                ...
                <v-card class="my-3" hover data-aos="zoom-in" data-aos-easing="ease">
                    ...
                    <v-card-actions>
                        ...
                        <v-btn icon class="red--text">
                            <v-icon class-blue--text>fa-reddit</v-icon>
                        </v-btn>
                        <v-btn icon class="light-blue--text">
                            <v-icon class-blue--text>fa-twitter</v-icon>
                        </v-btn>
                        <v-btn icon class="blue--text text--darken-4">
                            <v-icon class-blue--text>fa-facebook</v-icon>
                        </v-btn>
                        <v-btn icon class="blue--text text--darken-4">
                            <v-icon class-blue--text>fa-google-plus</v-icon>
                        </v-btn>
                        <v-btn icon class="blue--text text--darken-4">
                            <v-icon class-blue--text>fa-linkedin</v-icon>
                        </v-btn>
                        <v-spacer></v-spacer>
